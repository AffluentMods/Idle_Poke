...
public class CommandEvent {
    ...
    private final boolean isAuthorOwner;
    private String[] args;

    public CommandEvent(GuildMessageReceivedEvent event, boolean isAuthorOwner, String[] args) {
        this.event = event;
        this.isAuthorOwner = isAuthorOwner;
        this.args = args;
    }
